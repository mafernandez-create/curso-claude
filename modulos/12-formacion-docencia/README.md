# Módulo 12 — Formación y docencia sobre Claude
...
Preparar a formadores, docentes y responsables de diseño instruccional para **enseñar** el uso de Claude a terceros (equipo, alumnado, clientes, familia). No se trata solo de saber usar Claude, sino de saber transmitir su uso de forma responsable, adaptada al contexto y con sentido crítico.
...
Del catálogo:
- `teaching-ai-fluency` ⭐ (curso oficial).
...
Diseño completo de una **sesión formativa de 2 horas** para un público concreto (elige uno): equipo de marketing, desarrolladores junior, profesorado de secundaria, ONG, etc. Debe incluir: objetivos, guion, materiales, ejercicios y rúbrica de evaluación. Guardar en `modulos/12-formacion-docencia/sesion-formativa.md`.
